...
+ (BlockAlertView *)alertWithTitle:(NSString *)title message:(NSString *)message andLoadingviewEnabled:(bool)loadingEnabled
{
    return [[[BlockAlertView alloc] initWithTitle:title message:message andLoadingviewEnabled:loadingEnabled] autorelease];
}

///////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - NSObject

- (id)initWithTitle:(NSString *)title message:(NSString *)message andLoadingviewEnabled:(bool)loadingEnabled
{
    if ((self = [super init]))
    {
        ...
        if (loadingEnabled) {
            ...
            actInd.frame = CGRectMake(128.0f, 15.0f, 30.0f, 30.0f);
            [_view addSubview:actInd];
            [actInd startAnimating];
            
            
            
            CGSize size =actInd.frame.size;
            [actInd release];	
...
- (void)show
{
    ...
    // Show the BlockAlertView without animation
    _view.center = center;
...
- (void)buttonClicked:(id)sender 
{
    ...
    // Dismiss the BlockAlertView without animation
    [self dismissWithClickedButtonIndex:buttonIndex animated:NO];
    
    
//    // Dismiss the BlockAlertView with animation
